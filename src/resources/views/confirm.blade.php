...
<div class="contact-form__content">
    ...
    <form class="contact-form" action="/thanks" method="post">
        ...
        <div class="form__button">
            <button class="contact-form__button-submit" type="submit" formaction="/thanks" formmethod="post">送信</button>
            <button class="correction-form__button" type="submit" formaction="/" formmethod="get">修正</button>
        </div>
    </form>
</div>
